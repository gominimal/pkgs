...
for t in gcc g++ ld ar ranlib make sed grep tar find xargs sha256sum xz gawk patch zip unzip cpio file which pkg-config objcopy readelf autoconf python3; do
