...
for t in gcc g++ ld ar ranlib make sed grep tar find xargs sha256sum python3 xz gawk patch zip unzip cpio file which pkg-config objcopy readelf autoconf; do
