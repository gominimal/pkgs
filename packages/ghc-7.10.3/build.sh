#!/bin/bash
# ghc-7.10.3: one rung of the GHC ladder (7.6.3 -> 7.8.4 -> 7.10.3 -> 8.2.2 -> 8.6.5 -> 8.10.7 -> 9.2.8 -> 9.6.7 -> ghc).
# Builds GHC 7.10.3 from the pinned source tarball with the previous rung (/usr/lib/ghc-7.8.4) as the
# boot compiler and installs the whole compiler to /usr/lib/ghc-7.10.3 for the next rung.
...
SRC_SHA=cf90cedce1c28fd0e2b9e72fe8a938756668d18ea1fcc884a19f698658ac4fef
BUILDROOT="$(pwd)"
