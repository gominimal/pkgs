#!/bin/bash
# ghc-8.6.5: one rung of the GHC ladder (7.6.3 -> 7.8.4 -> 7.10.3 -> 8.2.2 -> 8.6.5 -> 8.10.7 -> 9.2.8 -> 9.6.7 -> ghc).
# Builds GHC 8.6.5 from the pinned source tarball with the previous rung (/usr/lib/ghc-8.2.2) as the
# boot compiler and installs the whole compiler to /usr/lib/ghc-8.6.5 for the next rung.
...
SRC_SHA=4d4aa1e96f4001b934ac6193ab09af5d6172f41f5a5d39d8e43393b9aafee361
BUILDROOT="$(pwd)"
