#!/bin/bash
# ghc-9.2.8: one rung of the GHC ladder (7.6.3 -> 7.8.4 -> 7.10.3 -> 8.2.2 -> 8.6.5 -> 8.10.7 -> 9.2.8 -> 9.6.7 -> ghc).
# Builds GHC 9.2.8 from the pinned source tarball with the previous rung (/usr/lib/ghc-8.10.7) as the
# boot compiler and installs the whole compiler to /usr/lib/ghc-9.2.8 for the next rung.
...
SRC_SHA=5f13d1786bf4fd12f4b45faa37abedb5bb3f36d5e58f7da5307e8bfe88a567a1
BUILDROOT="$(pwd)"
