...
for t in gcc g++ ld ar ranlib make sed grep tar find xargs sha256sum gawk xz gzip patch zip unzip cpio file which pkg-config xsltproc objcopy readelf; do
