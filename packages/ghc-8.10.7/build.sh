...
# Builds GHC 8.10.7 from the pinned source tarball with the previous rung (/usr/lib/ghc-8.6.5) as the
...
SRC_SHA=e3eef6229ce9908dfe1ea41436befb0455fefb1932559e860ad4c606b0d03c9d
BUILDROOT="$(pwd)"
